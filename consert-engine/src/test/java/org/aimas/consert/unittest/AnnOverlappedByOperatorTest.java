...
import org.aimas.consert.model.operators.AnnOverlappedByOperator.AnnOverlappedByEvaluatorDefinition;
...
public class AnnOverlappedByOperatorTest extends TestSetup {

    @Test
    public void testAnnOveralpsOperator() {
        ...
        KieSession kSession = getKieSessionFromResources(builderConf, null, 
        		"operator_test_rules/overlappedByTest.drl",
        ...
        long posStart = kSession.getSessionClock().getCurrentTime() - 10000;
        long posEnd = posStart + 10000;
    ...
    @Test
    public void testNotAnnOverlappedByOperator() {
        // setup KnowledgeBuilderConfiguration to add operator
        KnowledgeBuilderConfiguration builderConf = KnowledgeBuilderFactory.newKnowledgeBuilderConfiguration();
        builderConf.setOption(EvaluatorOption.get("annOverlaps", new AnnOverlapsOperator.AnnOverlapsEvaluatorDefinition()));
		builderConf.setOption(EvaluatorOption.get("annOverlappedBy", new AnnOverlappedByOperator.AnnOverlappedByEvaluatorDefinition()));
        ...
        // setup KieSession
        KieSession kSession = getKieSessionFromResources(builderConf, null, "operator_test_rules/overlappedByTest.drl", "casas_interwoven_constraints/PersonLocation_constraints.drl" );
        EventTracker eventTracker = new EventTracker(kSession);
        TrackingAgendaEventListener agendaEvListener = new TrackingAgendaEventListener();
        kSession.addEventListener(agendaEvListener);
