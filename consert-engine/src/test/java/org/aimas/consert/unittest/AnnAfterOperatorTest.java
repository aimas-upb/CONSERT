...
public class AnnAfterOperatorTest extends TestSetup {
	...
	public void testAnnAfterOperator() {
		...
		// setup KieSession
		KieSession kSession = getKieSessionFromResources(builderConf, null, "operator_test_rules/happensAfterTest.drl", "casas_interwoven_constraints/PersonLocation_constraints.drl" );
