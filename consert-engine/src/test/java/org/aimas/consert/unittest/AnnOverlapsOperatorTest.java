...
public class AnnOverlapsOperatorTest extends TestSetup {
    ...
    public void testNotAnnOverlapsOperator() {
		...
		// setup KieSession
		KieSession kSession = getKieSessionFromResources(builderConf, null, "operator_test_rules/overlapsTest.drl", "casas_interwoven_constraints/PersonLocation_constraints.drl" );
