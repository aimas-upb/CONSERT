...
public class CASASTestROSSingle extends TestSetup {
	...
	private static void runEvents(String filepath, String person, String task) throws Exception {
    	...
    	// create ConertEngineNode and add it as ContextAssertionListener
    	ConsertEngineROSNode engineROSNode = new ConsertEngineROSNode();
