...
public class Cabinet extends NaryContextAssertion {
	...
	public ContextAssertion cloneContent() {
		return new Cabinet(sensorId, status, location, eventId, null);
	}

	public Cabinet(String sensorId, String status, String location, int eventId,
